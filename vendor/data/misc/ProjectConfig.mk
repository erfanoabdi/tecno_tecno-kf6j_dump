...
#BSP: modify for KF6j KFLJHLEYB-2 by mingyuan.sun 20201111 start
BOOT_LOGO = hdplus1600
#BSP: modify for KF6j KFLJHLEYB-2 by mingyuan.sun 20201111 end
BUILD_AGO_GMS = no
BUILD_KERNEL = yes
BUILD_LK = yes
BUILD_MD32 = no
BUILD_PRELOADER = yes
#BSP: add project macro by wanghanfeng 20201104 start
CUSTOM_BUILD_VERNO = CY-KF6J-H6218-A
#BSP: add project macro by wanghanfeng 20201104 start
...
CUSTOM_HAL_IMGSENSOR = ov16b10_mipi_raw ov16b10ext2_mipi_raw ov8856ff_mipi_raw gc8034_mipi_raw gc6153_serial_yuv pblcov16b10_mipi_raw pblcov16b10ext2_mipi_raw pblcov8856ff_mipi_raw pblcgc8034_mipi_raw pblcgc6153_serial_yuv
CUSTOM_HAL_MAIN_IMGSENSOR = ov16b10_mipi_raw ov16b10ext2_mipi_raw
CUSTOM_TRAN_HAL_MAIN2_IMGSENSOR = gc6153_serial_yuv
CUSTOM_HAL_SUB_IMGSENSOR = ov8856ff_mipi_raw gc8034_mipi_raw
MTK_CAM_MAX_NUMBER_OF_CAMERA = 3
#ITD:modify by camera driver team end
#BSP: modify KFLJHLEYB-1 by yilong.luo for [P1 debug] 20201109 start
CUSTOM_HAL_MSENSORLIB =
#BSP: modify KFLJHLEYB-1 by yilong.luo for [P1 debug] 20201109 end
#BSP: add KFLJHLEYB-1 by yilong.luo for [P1 debug] 20201109 start
TRAN_SINGLE_ALS_CALI = yes
#BSP: add KFLJHLEYB-1 by yilong.luo for [P1 debug] 20201109 end
...
#ITD:modify by camera driver team start
CUSTOM_KERNEL_IMGSENSOR = ov16b10_mipi_raw ov16b10ext2_mipi_raw ov8856ff_mipi_raw gc8034_mipi_raw gc6153_serial_yuv
#ITD:modify by camera driver team end
...
CUSTOM_KERNEL_MAIN_IMGSENSOR = ov16b10_mipi_raw ov16b10ext2_mipi_raw
#ITD:modify by camera driver team end
...
#BSP: modify KFLJHLEYB-1 by yilong.luo for [P1 debug] 20201127 start
CUSTOM_KERNEL_SENSORHUB = yes
CUSTOM_KERNEL_SIGNIFICANT_MOTION_SENSOR = yes
#BSP: modify KFLJHLEYB-1 by yilong.luo for [P1 debug] 20201127 end
CUSTOM_KERNEL_SOUND = amp_6323pmic_spk
#BSP: modify KFLHLEYJ-34 by yilong.luo for open step 20201124 start
CUSTOM_KERNEL_STATIONARY_SENSOR = yes
CUSTOM_KERNEL_STEP_DETECTOR = yes
#BSP: modify KFLHLEYJ-34 by yilong.luo for open step 20201124 end
CUSTOM_KERNEL_STEP_COUNTER = yes
#ITD:modify by camera driver team start
CUSTOM_KERNEL_SUB_IMGSENSOR = ov8856ff_mipi_raw gc8034_mipi_raw
#ITD:modify by camera driver team end
...
#TSD:Modify KFLJHLEYB-5 by jinpeng.cheng 20201116
CUSTOM_MODEM=kf6j_h6218_a1
#TSD:Modify KFLJHLEYB-5 by jinpeng.cheng 20201116
...
#BSP:modify audio bring up KFLHLEYJ-5 haiping.bai 20201116 start
MTK_AUDIO_NUMBER_OF_MIC = 1
#BSP:modify audio bring up KFLHLEYJ-5 haiping.bai 20201116 end
...
#ITD:modify for kf6j by jianwei.he start
MTK_CAM_HDR_SUPPORT = no
#ITD:modify for kf6j by jianwei.he end
...
#ITD:modify kf6j by jianwei.he 20201118 begin
MTK_CAM_ZSDHDR_SUPPORT = no
#ITD:modify kf6j by jianwei.he 20201118 end
...
#TSD: modify VSIM  KFLJHLEYB-5 jinpeng.cheng 20201119 start
MTK_EXTERNAL_SIM_ONLY_SLOTS = 4
MTK_EXTERNAL_SIM_SUPPORT = yes
MTK_EXTERNAL_SIM_RSIM_ENHANCEMENT = yes
#TSD: modify VSIM  KFLJHLEYB-5 jinpeng.cheng 20201119 end
...
MTK_FM_SUPPORT = yes
#NFBD:add P1 test TSDT-151 by tieshan.huang 20210107 start
MTK_FM_GPIO_FUNC = yes
#NFBD:add P1 test TSDT-151 by tieshan.huang 20210107 end
...
MTK_IRTX_SUPPORT = no
#BSP:add kf7 charger function KFQHLEYJ-17 by yongxian.wang  20201020 start
MTK_JEITA_STANDARD_SUPPORT = yes
#BSP:add kf7 charger function KFQHLEYJ-17 by yongxian.wang  20201020 end
MTK_K64_SUPPORT=yes
...
#TSD:Modify KFLJHLEYB-5 by jinpeng.cheng 20201217
...
#TSD: modify modem KFLJHLEYB-5 by jinpeng.cheng 20201130 start
MTK_DYNAMIC_CCB_BUFFER_GEAR_ID =
#TSD: modify modem KFLJHLEYB-5 by jinpeng.cheng 20201130 end
...
MTK_TOUCHPANEL_KO =
#BSP: add project clone format by wanghanfeng 20201104 start
...
#BSP: add project clone format by wanghanfeng 20201104 end
#SDD: add project sw version by jiangping.guo 20201104 start
MTK_BUILD_VERNO=KF6j-H6218A-R-GL-210120V193
TRAN_FINGERPRINT_BUILD_VERNO=210120V193
#SDD: add project sw version by jiangping.guo 20201104 end
#BSP: add project macro by wanghanfeng 20201104 start
CUSTOM_TRAN_PROJECT=tran_kf6j
CUSTOM_TRAN_BOM=tran_kf6j_a1
#BSP: add project macro by wanghanfeng 20201104 end
TRAN_SEC_FILE_COPY_SUPPORT=yes
MTK_SECURITY_SW_SUPPORT=yes
MTK_FACTORY_MODE_IN_GB2312 = no
TRAN_TCM_SUPPORT=yes
